...
ambitoGobierno: {
clave: { type: String, enum: ['FEDERAL', 'ESTATAL', 'MUNICIPAL_ALCALDIA', 'OTRO'] },
valor: { type: String }
},
poderOrganoGobierno: {
type: String,
...
tipoArea: {
bienesServicios: {
claves: [{ type: String, enum: ['REQUIRENTE', 'CONTRATANTE', 'TECNICA', 'OTRA'] }],
otroValor: { type: String }
},
obraPublica: {
claves: [{ type: String, enum: ['REQUIRENTE', 'RESPONSABLE_CONTRATACION', 'TECNICA', 'RESPONSABLE_EJECUCION', 'OTRA'] }],
otroValor: { type: String }
}
},
